...
public class MobWalk : StateMachineBehaviour
{
    [SerializeField] private float speed = 2.5f;
    [SerializeField] private float attackRange = 5f;
    [SerializeField] private float m_WalkDistance = 20f;

    private MobAttack m_Attack;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_Attack = animator.GetComponent<MobAttack>();
    }
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if(m_Distance == m_WalkDistance)
            Managers.Instance.audioManager.Play("MobWalk");
        ...
        if (m_Attack.returnPos)
        {
            ...
            {
                animator.GetComponent<MobHealth>().Reset();
